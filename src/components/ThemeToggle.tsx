...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative p-2 rounded-lg bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 transition-colors hover:bg-zinc-200 dark:hover:bg-zinc-700"
